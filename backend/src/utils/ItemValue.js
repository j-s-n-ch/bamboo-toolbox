...
const rarityAdders = {
  common: { valueAdder: 0, modifierAdder: 0 },
  uncommon: { valueAdder: 1.5, modifierAdder: 1 },
  rare: { valueAdder: 3.5, modifierAdder: 2 },
  epic: { valueAdder: 5, modifierAdder: 3 },
  legendary: { valueAdder: 8, modifierAdder: 4.5 },
  ethereal: { valueAdder: 25.5, modifierAdder: 7 },
};
